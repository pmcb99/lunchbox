...
For a guided walkthrough of the database integration flow with pauses to review changes in the UI, run:
...
- Fetches metadata and lists databases
- Mutates the database (increases size)
- Fetches revisions
- Deletes the API key and tests revocation
- Pauses after each step for UI review
